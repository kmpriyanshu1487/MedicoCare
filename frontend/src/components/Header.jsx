        ...
        <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20' >
            <div className=' md;w-1/2 flex flex-col items-start justify-center gap-4 py-10 mm-auto md:py-[10vw]'>
                ...
                <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
                    ...
                    <p>Simply browse througn our existensive list of trusted doctors, <br className='hidden sm:block' /> schedule your appointment. </p>
                </div>
                <a href="#speciality"  className='flex items-centergap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md:m-0 gap-2 hover:scale-105 transition-all duration-300'>
